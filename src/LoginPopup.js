...
const LoginPopup = ({ onClose }) => {
    ...
    const handleLogin = async () => {
        ...
        try {
            const response = await fetch("http://44.211.62.166/auth/login", {
                method: "POST",
    ...
    const handleSignup = async () => {
        ...
        try {
            const response = await fetch("http://44.211.62.166/auth/signup", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    const handleVerifyOtp = async () => {
        ...
        try {
            const response = await fetch("http://44.211.62.166/auth/verify-otp", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    const handleResendOtp = async () => {
        ...
        try {
            const response = await fetch("http://44.211.62.166/auth/resend-otp", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    const handleForgotPassword = async () => {
        ...
        try {
            const response = await fetch("http://44.211.62.166/auth/forgot-password", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({ username })
            });
